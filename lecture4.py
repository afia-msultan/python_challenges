...
is_even_with_return(3)  # evaluated to False but will not be printed
print(is_even_with_return(3))   # evaluated to False which will not be printed
...
is_even_without_return(3)   # evaluated to None but will not be printed
print(is_even_without_return(3))   # evaluated to None which will not be printed
